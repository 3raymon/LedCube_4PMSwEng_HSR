...
class Cube
{
	public:
		...
		void ebeneNachHinten(struct ledarray* struct_ptr); //Noch nicht implementiert
		void rain(void);
		void zufall(void);
		void strobo(void);
		void aufab(void);
		...
		void audioanalyse(void);		//Noch nicht implementiert
		void analogUmrechnung(int value, int i);	//Noch nicht implementiert
